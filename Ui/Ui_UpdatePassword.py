...
# Form implementation generated from reading ui file 'E:\WorkSpace\gloves_test\Program\Ui\UpdatePassword.ui'
#
...
class Ui_UpdatePassword(object):
    def setupUi(self, UpdatePassword):
        ...
        self._2.addWidget(self.okButton)
        ...
        QtCore.QObject.connect(self.okButton, QtCore.SIGNAL(_fromUtf8("clicked()")), UpdatePassword.btn_Ok_UpdatePassword)
        QtCore.QObject.connect(self.cancelButton, QtCore.SIGNAL(_fromUtf8("clicked()")), UpdatePassword.btn_Cancel_close)
