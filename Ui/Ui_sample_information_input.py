...
class Ui_sample_information_input(object):
    def setupUi(self, sample_information_input):
        ...
        self.le_2_color = QtGui.QLineEdit(self.layoutWidget1)
        ...
        self.le_3_color = QtGui.QLineEdit(self.layoutWidget2)
        ...
        sample_information_input.setTabOrder(self.le_1_color, self.cb_1_mtype)
        ...
        sample_information_input.setTabOrder(self.le_2_color, self.cb_2_mtype)
        ...
        sample_information_input.setTabOrder(self.le_3_color, self.cb_3_mtype)
