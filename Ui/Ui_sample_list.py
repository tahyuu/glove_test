...
class Ui_sample_list(object):
    def setupUi(self, sample_list):
        ...
        self.pushButton = QtGui.QPushButton(sample_list)
...
"   border-style: outset;"))
        ...
        QtCore.QObject.connect(self.pushButton, QtCore.SIGNAL(_fromUtf8("clicked()")), sample_list.on_btnExport_clicked)
    ...
    def retranslateUi(self, sample_list):
        ...
        self.pushButton.setText(_translate("sample_list", "Export Result", None))
